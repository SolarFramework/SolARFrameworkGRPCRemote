...
class setTrackablesRequest final :
 ...
 public:
  ...
  void MergeFrom( const setTrackablesRequest& from) {
    setTrackablesRequest::MergeImpl(*this, from);
  }
  private:
...
class setTrackablesResponse final :
 ...
 public:
  ...
  void MergeFrom( const setTrackablesResponse& from) {
    setTrackablesResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void setTrackablesRequest::set_trackables(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.trackables_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* setTrackablesRequest::release_trackables() {
  ...
  return _impl_.trackables_.Release();
}
inline void setTrackablesRequest::set_allocated_trackables(std::string* trackables) {
  ...
  _impl_.trackables_.SetAllocated(trackables, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.trackables_.IsDefault()) {
