...
#ifndef GRPC_grpcIHomographyValidationService_2eproto__INCLUDED
#define GRPC_grpcIHomographyValidationService_2eproto__INCLUDED
...
class grpcIHomographyValidationService final {
 public:
  static constexpr char const* service_full_name() {
    return "grpcIHomographyValidation.grpcIHomographyValidationService";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    virtual ::grpc::Status isValid(::grpc::ClientContext* context, const ::grpcIHomographyValidation::isValidRequest& request, ::grpcIHomographyValidation::isValidResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpcIHomographyValidation::isValidResponse>> AsyncisValid(::grpc::ClientContext* context, const ::grpcIHomographyValidation::isValidRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpcIHomographyValidation::isValidResponse>>(AsyncisValidRaw(context, request, cq));
    }
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status isValid(::grpc::ServerContext* context, const ::grpcIHomographyValidation::isValidRequest* request, ::grpcIHomographyValidation::isValidResponse* response);
  };
  ...
  class WithAsyncMethod_isValid : public BaseClass {
   ...
   public:
    ...
    void RequestisValid(::grpc::ServerContext* context, ::grpcIHomographyValidation::isValidRequest* request, ::grpc::ServerAsyncResponseWriter< ::grpcIHomographyValidation::isValidResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithStreamedUnaryMethod_isValid : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_isValid() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpcIHomographyValidation::isValidRequest, ::grpcIHomographyValidation::isValidResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpcIHomographyValidation::isValidRequest, ::grpcIHomographyValidation::isValidResponse>* streamer) {
    ...
    virtual ::grpc::Status StreamedisValid(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpcIHomographyValidation::isValidRequest,::grpcIHomographyValidation::isValidResponse>* server_unary_streamer) = 0;
  };
...
#endif  // GRPC_grpcIHomographyValidationService_2eproto__INCLUDED
