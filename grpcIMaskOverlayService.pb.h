...
void draw_grpc0Request::set_masks(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.masks_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void draw_grpc0Request::set_allocated_masks(std::string* masks) {
  ...
  _impl_.masks_.SetAllocated(masks, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.masks_.IsDefault()) {
...
void draw_grpc0Request::set_classids(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.classids_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* draw_grpc0Request::release_classids() {
  ...
  return _impl_.classids_.Release();
}
inline void draw_grpc0Request::set_allocated_classids(std::string* classids) {
  ...
  _impl_.classids_.SetAllocated(classids, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.classids_.IsDefault()) {
