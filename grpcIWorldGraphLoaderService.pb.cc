...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_grpcIWorldGraphLoaderService_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_grpcIWorldGraphLoaderService_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_grpcIWorldGraphLoaderService_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_grpcIWorldGraphLoaderService_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::grpcIWorldGraphLoader::_loadRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::grpcIWorldGraphLoader::_loadResponse_default_instance_),
};
...
descriptor_table_grpcIWorldGraphLoaderService_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_grpcIWorldGraphLoaderService_2eproto);
  return descriptor_table_grpcIWorldGraphLoaderService_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_grpcIWorldGraphLoaderService_2eproto(&descriptor_table_grpcIWorldGraphLoaderService_2eproto);
namespace grpcIWorldGraphLoader {
...
// @@protoc_insertion_point(generalized_merge_from_start:grpcIWorldGraphLoader.loadRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const loadRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<loadRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:grpcIWorldGraphLoader.loadRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:grpcIWorldGraphLoader.loadRequest)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:grpcIWorldGraphLoader.loadRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(generalized_merge_from_start:grpcIWorldGraphLoader.loadResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const loadResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<loadResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:grpcIWorldGraphLoader.loadResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:grpcIWorldGraphLoader.loadResponse)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:grpcIWorldGraphLoader.loadResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::grpcIWorldGraphLoader::loadRequest* Arena::CreateMaybeMessage< ::grpcIWorldGraphLoader::loadRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::grpcIWorldGraphLoader::loadRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::grpcIWorldGraphLoader::loadResponse* Arena::CreateMaybeMessage< ::grpcIWorldGraphLoader::loadResponse >(Arena* arena) {
