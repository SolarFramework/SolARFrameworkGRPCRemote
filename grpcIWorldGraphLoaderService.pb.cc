...
const uint32_t TableStruct_grpcIWorldGraphLoaderService_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::grpcIWorldGraphLoader::loadRequest, _impl_.grpcservercompressionformat_),
  PROTOBUF_FIELD_OFFSET(::grpcIWorldGraphLoader::loadRequest, _impl_.trackables_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::grpcIWorldGraphLoader::loadResponse, _impl_.trackables_),
  PROTOBUF_FIELD_OFFSET(::grpcIWorldGraphLoader::loadResponse, _impl_.xpcfgrpcreturnvalue_),
};
