...
void transformInPlace_grpc4Request::set_keyframecollection(ArgT0&& arg0, ArgT... args) {
 ...
 keyframecollection_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void transformInPlace_grpc4Request::_internal_set_keyframecollection(const std::string& value) {
  ...
  keyframecollection_.Set(value, GetArenaForAllocation());
}
inline std::string* transformInPlace_grpc4Request::_internal_mutable_keyframecollection() {
  
  return keyframecollection_.Mutable(GetArenaForAllocation());
}
inline std::string* transformInPlace_grpc4Request::release_keyframecollection() {
  ...
  return keyframecollection_.Release();
}
inline void transformInPlace_grpc4Request::set_allocated_keyframecollection(std::string* keyframecollection) {
  ...
  keyframecollection_.SetAllocated(keyframecollection, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (keyframecollection_.IsDefault()) {
