...
std::unique_ptr< grpcIContoursFilterService::Stub> grpcIContoursFilterService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< grpcIContoursFilterService::Stub> stub(new grpcIContoursFilterService::Stub(channel, options));
  return stub;
}

grpcIContoursFilterService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_filter_(grpcIContoursFilterService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void grpcIContoursFilterService::Stub::async::filter(::grpc::ClientContext* context, const ::grpcIContoursFilter::filterRequest* request, ::grpcIContoursFilter::filterResponse* response, std::function<void(::grpc::Status)> f) {
...
void grpcIContoursFilterService::Stub::async::filter(::grpc::ClientContext* context, const ::grpcIContoursFilter::filterRequest* request, ::grpcIContoursFilter::filterResponse* response, ::grpc::ClientUnaryReactor* reactor) {
