...
inline void unproject_grpc0Request::set_camparams(const std::string& value) {
...
inline void unproject_grpc0Request::set_camparams(std::string&& value) {
  
  camparams_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:grpcIUnproject.unproject_grpc0Request.camParams)
}
inline void unproject_grpc0Request::set_camparams(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  camparams_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:grpcIUnproject.unproject_grpc0Request.camParams)
}
inline void unproject_grpc0Request::set_camparams(const void* value,
    size_t size) {
  
  camparams_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:grpcIUnproject.unproject_grpc0Request.camParams)
}
...
inline void unproject_grpc1Request::set_camparams(const std::string& value) {
  _internal_set_camparams(value);
...
inline void unproject_grpc1Request::set_camparams(std::string&& value) {
  
  camparams_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:grpcIUnproject.unproject_grpc1Request.camParams)
}
inline void unproject_grpc1Request::set_camparams(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  camparams_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:grpcIUnproject.unproject_grpc1Request.camParams)
}
inline void unproject_grpc1Request::set_camparams(const void* value,
    size_t size) {
  
  camparams_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:grpcIUnproject.unproject_grpc1Request.camParams)
}
