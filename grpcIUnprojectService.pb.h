...
void unproject_grpc1Request::set_imagekeypoints(ArgT0&& arg0, ArgT... args) {
 ...
 imagekeypoints_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void unproject_grpc1Request::_internal_set_imagekeypoints(const std::string& value) {
  ...
  imagekeypoints_.Set(value, GetArenaForAllocation());
}
inline std::string* unproject_grpc1Request::_internal_mutable_imagekeypoints() {
  
  return imagekeypoints_.Mutable(GetArenaForAllocation());
}
inline std::string* unproject_grpc1Request::release_imagekeypoints() {
  ...
  return imagekeypoints_.Release();
}
inline void unproject_grpc1Request::set_allocated_imagekeypoints(std::string* imagekeypoints) {
  ...
  imagekeypoints_.SetAllocated(imagekeypoints, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (imagekeypoints_.IsDefault()) {
