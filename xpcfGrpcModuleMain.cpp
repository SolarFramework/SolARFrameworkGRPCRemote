...
extern "C" XPCF_MODULEHOOKS_API xpcf::XPCFErrorCode XPCF_getComponent(const boost::uuids::uuid& componentUUID,SRef<xpcf::IComponentIntrospect>& interfaceRef)
{
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIMaskOverlay::IMaskOverlay_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIMaskOverlay::IMaskOverlay_grpcServer>(componentUUID,interfaceRef);
  }
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyI2DTrackablesDetector::I2DTrackablesDetector_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverI2DTrackablesDetector::I2DTrackablesDetector_grpcServer>(componentUUID,interfaceRef);
  }
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIMeshLoader::IMeshLoader_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIMeshLoader::IMeshLoader_grpcServer>(componentUUID,interfaceRef);
  }
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIMeshExporter::IMeshExporter_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIMeshExporter::IMeshExporter_grpcServer>(componentUUID,interfaceRef);
  }
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIInstanceSegmentation::IInstanceSegmentation_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIInstanceSegmentation::IInstanceSegmentation_grpcServer>(componentUUID,interfaceRef);
  }
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIMultiTrackablesPose::IMultiTrackablesPose_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIMultiTrackablesPose::IMultiTrackablesPose_grpcServer>(componentUUID,interfaceRef);
  }
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyIMaskOverlay::IMaskOverlay_grpcProxy)
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::serverIMaskOverlay::IMaskOverlay_grpcServer)
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyI2DTrackablesDetector::I2DTrackablesDetector_grpcProxy)
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::serverI2DTrackablesDetector::I2DTrackablesDetector_grpcServer)
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyIMeshLoader::IMeshLoader_grpcProxy)
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::serverIMeshLoader::IMeshLoader_grpcServer)
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyIMeshExporter::IMeshExporter_grpcProxy)
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyIMultiTrackablesPose::IMultiTrackablesPose_grpcProxy)
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::serverIMultiTrackablesPose::IMultiTrackablesPose_grpcServer)
