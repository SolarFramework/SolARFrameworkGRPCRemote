...
PROTOBUF_CONSTEXPR processRequest::processRequest(
  ...
  , /*decltype(_impl_.view_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_grpcIBootstrapperService_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::grpcIBootstrapper::processRequest, _impl_.grpcservercompressionformat_),
  PROTOBUF_FIELD_OFFSET(::grpcIBootstrapper::processRequest, _impl_.frame_),
  PROTOBUF_FIELD_OFFSET(::grpcIBootstrapper::processRequest, _impl_.view_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::grpcIBootstrapper::processResponse, _impl_.view_),
  PROTOBUF_FIELD_OFFSET(::grpcIBootstrapper::processResponse, _impl_.xpcfgrpcreturnvalue_),
};
...
processRequest::processRequest(const processRequest& from)
  ...
  _impl_.view_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.view_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_view().empty()) {
    _this->_impl_.view_.Set(from._internal_view(), 
      _this->GetArenaForAllocation());
  }
...
void processRequest::InternalSwap(processRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.view_, lhs_arena,
      &other->_impl_.view_, rhs_arena
  );
