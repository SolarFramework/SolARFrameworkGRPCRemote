...
const char descriptor_table_protodef_grpcIBootstrapperService_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "tstrapperService\022^\n\023setCameraParameters\022"
  "-.grpcIBootstrapper.setCameraParametersR"
  "equest\032\026.google.protobuf.Empty\"\000\022R\n\007proc"
  "ess\022!.grpcIBootstrapper.processRequest\032\""
  ".grpcIBootstrapper.processResponse\"\000b\006pr"
  "oto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_grpcIBootstrapperService_2eproto = {
  false, false, 524, descriptor_table_protodef_grpcIBootstrapperService_2eproto, "grpcIBootstrapperService.proto", 
...
// @@protoc_insertion_point(generalized_merge_from_start:grpcIBootstrapper.setCameraParametersRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const setCameraParametersRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<setCameraParametersRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:grpcIBootstrapper.setCameraParametersRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:grpcIBootstrapper.setCameraParametersRequest)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:grpcIBootstrapper.setCameraParametersRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
