...
::grpc::Status ITrackableLoader_grpcServer::grpcITrackableLoaderServiceImpl::loadTrackable(::grpc::ServerContext* context, const ::grpcITrackableLoader::loadTrackableRequest* request, ::grpcITrackableLoader::loadTrackableResponse* response)
{
  ...
  xpcf::grpcServerCompressionInfos serverCompressInfo = xpcf::deduceServerCompressionType(askedCompressionType, m_serviceCompressionInfos, "loadTrackable", m_methodCompressionInfosMap);
  xpcf::prepareServerCompressionContext(context, serverCompressInfo);
  #endif
  #ifdef ENABLE_SERVER_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> ITrackableLoader_grpcServer::loadTrackable request received at " << to_simple_string(start) << std::endl;
  #endif
  ...
  std::cout << "====> ITrackableLoader_grpcServer::loadTrackable response sent at " << to_simple_string(end) << std::endl;
