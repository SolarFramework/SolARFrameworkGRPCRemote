...
inline void setCameraParametersRequest::set_intrinsicparams(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:grpcIMapping.setCameraParametersRequest.intrinsicParams)
}
inline void setCameraParametersRequest::set_intrinsicparams(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:grpcIMapping.setCameraParametersRequest.intrinsicParams)
}
inline void setCameraParametersRequest::set_intrinsicparams(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:grpcIMapping.setCameraParametersRequest.intrinsicParams)
}
...
inline void setCameraParametersRequest::set_distorsionparams(std::string&& value) {
  ...
  distorsionparams_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:grpcIMapping.setCameraParametersRequest.distorsionParams)
}
inline void setCameraParametersRequest::set_distorsionparams(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:grpcIMapping.setCameraParametersRequest.distorsionParams)
}
inline void setCameraParametersRequest::set_distorsionparams(const void* value,
  ...
  distorsionparams_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:grpcIMapping.setCameraParametersRequest.distorsionParams)
}
