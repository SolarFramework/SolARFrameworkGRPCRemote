...
void processRequest::set_view(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.view_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void processRequest::set_allocated_view(std::string* view) {
  ...
  _impl_.view_.SetAllocated(view, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.view_.IsDefault()) {
