...
static const char* grpcIOverlapDetectorService_method_names[] = {
  "/grpcIOverlapDetector.grpcIOverlapDetectorService/setCameraParameters",
...
::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* grpcIOverlapDetectorService::Stub::PrepareAsyncsetCameraParametersRaw(::grpc::ClientContext* context, const ::grpcIOverlapDetector::setCameraParametersRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::google::protobuf::Empty, ::grpcIOverlapDetector::setCameraParametersRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_setCameraParameters_, context, request);
}

::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* grpcIOverlapDetectorService::Stub::AsyncsetCameraParametersRaw(::grpc::ClientContext* context, const ::grpcIOverlapDetector::setCameraParametersRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
grpcIOverlapDetectorService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< grpcIOverlapDetectorService::Service, ::grpcIOverlapDetector::setCameraParametersRequest, ::google::protobuf::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](grpcIOverlapDetectorService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::grpcIOverlapDetector::setCameraParametersRequest* req,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      grpcIOverlapDetectorService_method_names[2],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
...
::grpc::Status grpcIOverlapDetectorService::Service::setCameraParameters(::grpc::ServerContext* context, const ::grpcIOverlapDetector::setCameraParametersRequest* request, ::google::protobuf::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
