...
inline void estimateRequest::set_camparams(std::string&& value) {
  ...
  camparams_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:grpcITrackablePose.estimateRequest.camParams)
}
inline void estimateRequest::set_camparams(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:grpcITrackablePose.estimateRequest.camParams)
}
inline void estimateRequest::set_camparams(const void* value,
  ...
  camparams_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:grpcITrackablePose.estimateRequest.camParams)
}
