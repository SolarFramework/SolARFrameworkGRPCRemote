...
class ITriangulator_grpcProxy:  public org::bcom::xpcf::ConfigurableBase, virtual public SolAR::api::solver::map::ITriangulator {
  public:
    ...
    double triangulate(SRef<SolAR::datastructure::Frame> frame1, SRef<SolAR::datastructure::Frame> frame2, std::vector<SolAR::datastructure::DescriptorMatch> const& matches, std::pair<uint32_t,uint32_t> const& working_views, SolAR::datastructure::CameraParameters const& camParams1, SolAR::datastructure::CameraParameters const& camParams2, std::vector<SRef<SolAR::datastructure::CloudPoint>>& pcloud, bool const& onlyDepth)     override;
