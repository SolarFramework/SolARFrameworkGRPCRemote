  ...
  class WithCallbackMethod_filter : public BaseClass {
   ...
   public:
    WithCallbackMethod_filter() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpcIPCFilter::filterRequest, ::grpcIPCFilter::filterResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpcIPCFilter::filterRequest* request, ::grpcIPCFilter::filterResponse* response) { return this->filter(context, request, response); }));}
    void SetMessageAllocatorFor_filter(
        ::grpc::MessageAllocator< ::grpcIPCFilter::filterRequest, ::grpcIPCFilter::filterResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* filter(
      ::grpc::CallbackServerContext* /*context*/, const ::grpcIPCFilter::filterRequest* /*request*/, ::grpcIPCFilter::filterResponse* /*response*/)  { return nullptr; }
  };
