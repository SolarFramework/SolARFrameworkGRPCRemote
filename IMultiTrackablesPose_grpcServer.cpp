...
::grpc::Status IMultiTrackablesPose_grpcServer::grpcIMultiTrackablesPoseServiceImpl::setCameraParameters(::grpc::ServerContext* context, const ::grpcIMultiTrackablesPose::setCameraParametersRequest* request, ::google::protobuf::Empty* response)
{
  #ifdef ENABLE_SERVER_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IMultiTrackablesPose_grpcServer::setCameraParameters request received at " << to_simple_string(start) << std::endl;
  #endif
  ...
  std::cout << "====> IMultiTrackablesPose_grpcServer::setCameraParameters response sent at " << to_simple_string(end) << std::endl;
