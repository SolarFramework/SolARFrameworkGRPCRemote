...
SolAR::FrameworkReturnCode  IMultiTrackablesPose_grpcProxy::estimate(SRef<SolAR::datastructure::Image> const image, SolAR::datastructure::CameraParameters const& camParams, SolAR::datastructure::Transform3Df& pose)
{
  ::grpc::ClientContext context;
