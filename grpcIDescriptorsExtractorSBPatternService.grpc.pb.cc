...
std::unique_ptr< grpcIDescriptorsExtractorSBPatternService::Stub> grpcIDescriptorsExtractorSBPatternService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< grpcIDescriptorsExtractorSBPatternService::Stub> stub(new grpcIDescriptorsExtractorSBPatternService::Stub(channel));
  return stub;
}

grpcIDescriptorsExtractorSBPatternService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_extract_grpc0_(grpcIDescriptorsExtractorSBPatternService_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_extract_grpc1_(grpcIDescriptorsExtractorSBPatternService_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void grpcIDescriptorsExtractorSBPatternService::Stub::experimental_async::extract_grpc0(::grpc::ClientContext* context, const ::grpcIDescriptorsExtractorSBPattern::extract_grpc0Request* request, ::grpcIDescriptorsExtractorSBPattern::extract_grpc0Response* response, std::function<void(::grpc::Status)> f) {
...
void grpcIDescriptorsExtractorSBPatternService::Stub::experimental_async::extract_grpc0(::grpc::ClientContext* context, const ::grpcIDescriptorsExtractorSBPattern::extract_grpc0Request* request, ::grpcIDescriptorsExtractorSBPattern::extract_grpc0Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void grpcIDescriptorsExtractorSBPatternService::Stub::experimental_async::extract_grpc1(::grpc::ClientContext* context, const ::grpcIDescriptorsExtractorSBPattern::extract_grpc1Request* request, ::grpcIDescriptorsExtractorSBPattern::extract_grpc1Response* response, std::function<void(::grpc::Status)> f) {
...
void grpcIDescriptorsExtractorSBPatternService::Stub::experimental_async::extract_grpc1(::grpc::ClientContext* context, const ::grpcIDescriptorsExtractorSBPattern::extract_grpc1Request* request, ::grpcIDescriptorsExtractorSBPattern::extract_grpc1Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
