...
extern "C" XPCF_MODULEHOOKS_API xpcf::XPCFErrorCode XPCF_getComponent(const boost::uuids::uuid& componentUUID,SRef<xpcf::IComponentIntrospect>& interfaceRef)
{
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIImageSegmentationPipeline::IImageSegmentationPipeline_grpcServer>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIMapProcessingPipeline::IMapProcessingPipeline_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIMapProcessingPipeline::IMapProcessingPipeline_grpcServer>(componentUUID,interfaceRef);
  }
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIRelocalizationTrackablePipeline::IRelocalizationTrackablePipeline_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIRelocalizationTrackablePipeline::IRelocalizationTrackablePipeline_grpcServer>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIClientContextManager::IClientContextManager_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIClientContextManager::IClientContextManager_grpcServer>(componentUUID,interfaceRef);
  }
  ...
  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {
    ...
    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::proxyIMapsManager::IMapsManager_grpcProxy>(componentUUID,interfaceRef);
  }

  if (errCode != xpcf::XPCFErrorCode::_SUCCESS)   {

    errCode = xpcf::tryCreateComponent<org::bcom::xpcf::grpc::serverIMapsManager::IMapsManager_grpcServer>(componentUUID,interfaceRef);
  }
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::serverIMapProcessingPipeline::IMapProcessingPipeline_grpcServer)
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyIRelocalizationTrackablePipeline::IRelocalizationTrackablePipeline_grpcProxy)
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::serverIRelocalizationTrackablePipeline::IRelocalizationTrackablePipeline_grpcServer)
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyIClientContextManager::IClientContextManager_grpcProxy)
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::serverIClientContextManager::IClientContextManager_grpcServer)
...
XPCF_ADD_COMPONENT(org::bcom::xpcf::grpc::proxyIMapsManager::IMapsManager_grpcProxy)
