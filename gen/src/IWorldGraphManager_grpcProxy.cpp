...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getRelocalizationInformation(std::vector<std::tuple<org::bcom::xpcf::uuids::uuid,bool>> const& uuids, std::string const& token, std::vector<SolAR::datastructure::StorageCapabilities> const& capability, std::vector<SolAR::datastructure::RelocalizationInformation>& relocalizationInformation)
{
  ...
  reqIn.set_capability(xpcf::serialize<std::vector<SolAR::datastructure::StorageCapabilities>>(capability));
  reqIn.set_relocalizationinformation(xpcf::serialize<std::vector<SolAR::datastructure::RelocalizationInformation>>(relocalizationInformation));
  ...
  relocalizationInformation = xpcf::deserialize<std::vector<SolAR::datastructure::RelocalizationInformation>>(respOut.relocalizationinformation());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}


SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldElement(org::bcom::xpcf::uuids::uuid const& worldElementId, SRef<SolAR::datastructure::StorageWorldElement>& worldElement)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_worldelement(xpcf::serialize<SRef<SolAR::datastructure::StorageWorldElement>>(worldElement));
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  ...
  worldElement = xpcf::deserialize<SRef<SolAR::datastructure::StorageWorldElement>>(respOut.worldelement());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}


SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldElements(std::vector<SRef<SolAR::datastructure::StorageWorldElement>>& vector)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_grpcservercompressionformat (static_cast<int32_t>(serverCompressionType));
  #endif
  reqIn.set_vector(xpcf::serialize<std::vector<SRef<SolAR::datastructure::StorageWorldElement>>>(vector));
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  ...
  vector = xpcf::deserialize<std::vector<SRef<SolAR::datastructure::StorageWorldElement>>>(respOut.vector());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}


SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldElementByKeyValue(std::string const& key, std::string const& value, std::vector<SRef<SolAR::datastructure::StorageWorldElement>>& vector)
{
  ::grpc::ClientContext context;
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldElementByKey(std::string const& key, std::vector<SRef<SolAR::datastructure::StorageWorldElement>>& vector)
{
  ::grpc::ClientContext context;
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::addTrackable(org::bcom::xpcf::uuids::uuid& id, SRef<SolAR::datastructure::StorageTrackable> trackable)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_grpcservercompressionformat (static_cast<int32_t>(serverCompressionType));
  #endif
  reqIn.set_trackable(xpcf::serialize<SRef<SolAR::datastructure::StorageTrackable>>(trackable));
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getTrackable(org::bcom::xpcf::uuids::uuid const& trackableId, SRef<SolAR::datastructure::StorageTrackable>& trackable)
{
  ::grpc::ClientContext context;
  ...
  trackable = xpcf::deserialize<SRef<SolAR::datastructure::StorageTrackable>>(respOut.trackable());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getTrackables(std::vector<SRef<SolAR::datastructure::StorageTrackable>>& vector)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_grpcservercompressionformat (static_cast<int32_t>(serverCompressionType));
  #endif
  reqIn.set_vector(xpcf::serialize<std::vector<SRef<SolAR::datastructure::StorageTrackable>>>(vector));
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  ...
  vector = xpcf::deserialize<std::vector<SRef<SolAR::datastructure::StorageTrackable>>>(respOut.vector());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}


SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::modifyTrackable(org::bcom::xpcf::uuids::uuid& id, SRef<SolAR::datastructure::StorageTrackable> trackable)
{
  ::grpc::ClientContext context;
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::addWorldAnchor(org::bcom::xpcf::uuids::uuid& id, SRef<SolAR::datastructure::StorageWorldAnchor> worldAnchor)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_grpcservercompressionformat (static_cast<int32_t>(serverCompressionType));
  #endif
  reqIn.set_worldanchor(xpcf::serialize<SRef<SolAR::datastructure::StorageWorldAnchor>>(worldAnchor));
  reqIn.set_id(xpcf::serialize<org::bcom::xpcf::uuids::uuid>(id));
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldAnchor(org::bcom::xpcf::uuids::uuid const& worldAnchorId, SRef<SolAR::datastructure::StorageWorldAnchor>& worldAnchor)
{
  ::grpc::ClientContext context;
  ...
  worldAnchor = xpcf::deserialize<SRef<SolAR::datastructure::StorageWorldAnchor>>(respOut.worldanchor());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldAnchors(std::vector<SRef<SolAR::datastructure::StorageWorldAnchor>>& vector)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_grpcservercompressionformat (static_cast<int32_t>(serverCompressionType));
  #endif
  reqIn.set_vector(xpcf::serialize<std::vector<SRef<SolAR::datastructure::StorageWorldAnchor>>>(vector));
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  ...
  vector = xpcf::deserialize<std::vector<SRef<SolAR::datastructure::StorageWorldAnchor>>>(respOut.vector());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}


SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::modifyWorldAnchor(org::bcom::xpcf::uuids::uuid& id, SRef<SolAR::datastructure::StorageWorldAnchor> worldAnchor)
{
  ::grpc::ClientContext context;
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::addWorldLink(org::bcom::xpcf::uuids::uuid& id, SRef<SolAR::datastructure::StorageWorldLink> worldLink)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_grpcservercompressionformat (static_cast<int32_t>(serverCompressionType));
  #endif
  reqIn.set_worldlink(xpcf::serialize<SRef<SolAR::datastructure::StorageWorldLink>>(worldLink));
  reqIn.set_id(xpcf::serialize<org::bcom::xpcf::uuids::uuid>(id));
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldLink(org::bcom::xpcf::uuids::uuid const& parentId, org::bcom::xpcf::uuids::uuid const& childId, SRef<SolAR::datastructure::StorageWorldLink>& worldLink)
{
  ::grpc::ClientContext context;
  ...
  worldLink = xpcf::deserialize<SRef<SolAR::datastructure::StorageWorldLink>>(respOut.worldlink());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}


SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldLink(org::bcom::xpcf::uuids::uuid const& linkId, SRef<SolAR::datastructure::StorageWorldLink>& worldLink)
{
  ::grpc::ClientContext context;
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::getWorldLinks(std::vector<SRef<SolAR::datastructure::StorageWorldLink>>& vector)
{
  ::grpc::ClientContext context;
  ...
  reqIn.set_grpcservercompressionformat (static_cast<int32_t>(serverCompressionType));
  #endif
  reqIn.set_vector(xpcf::serialize<std::vector<SRef<SolAR::datastructure::StorageWorldLink>>>(vector));
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  ...
  vector = xpcf::deserialize<std::vector<SRef<SolAR::datastructure::StorageWorldLink>>>(respOut.vector());
  return static_cast<SolAR::FrameworkReturnCode>(respOut.xpcfgrpcreturnvalue());
}


SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::modifyWorldLink(org::bcom::xpcf::uuids::uuid& id, SRef<SolAR::datastructure::StorageWorldLink> worldLink)
{
  ::grpc::ClientContext context;
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::saveToFile() const
{
  ::grpc::ClientContext context;
  ::grpcIWorldGraphManager::saveToFileRequest reqIn;
  ::grpcIWorldGraphManager::saveToFileResponse respOut;
  #ifndef DISABLE_GRPC_COMPRESSION
  ...
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IWorldGraphManager_grpcProxy::saveToFile request sent at " << to_simple_string(start) << std::endl;
  #endif
  ::grpc::Status grpcRemoteStatus = m_grpcStub->saveToFile(&context, reqIn, &respOut);
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime end = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IWorldGraphManager_grpcProxy::saveToFile response received at " << to_simple_string(end) << std::endl;
  std::cout << "   => elapsed time = " << ((end - start).total_microseconds() / 1000.00) << " ms" << std::endl;
  #endif
  if (!grpcRemoteStatus.ok())  {
    std::cout << "saveToFile rpc failed." << std::endl;
    throw xpcf::RemotingException("grpcIWorldGraphManagerService","saveToFile",static_cast<uint32_t>(grpcRemoteStatus.error_code()));
  }
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::loadFromFile()
{
  ::grpc::ClientContext context;
  ::grpcIWorldGraphManager::loadFromFileRequest reqIn;
  ::grpcIWorldGraphManager::loadFromFileResponse respOut;
  #ifndef DISABLE_GRPC_COMPRESSION
  ...
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IWorldGraphManager_grpcProxy::loadFromFile request sent at " << to_simple_string(start) << std::endl;
  #endif
  ::grpc::Status grpcRemoteStatus = m_grpcStub->loadFromFile(&context, reqIn, &respOut);
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime end = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IWorldGraphManager_grpcProxy::loadFromFile response received at " << to_simple_string(end) << std::endl;
  std::cout << "   => elapsed time = " << ((end - start).total_microseconds() / 1000.00) << " ms" << std::endl;
  #endif
  if (!grpcRemoteStatus.ok())  {
    std::cout << "loadFromFile rpc failed." << std::endl;
    throw xpcf::RemotingException("grpcIWorldGraphManagerService","loadFromFile",static_cast<uint32_t>(grpcRemoteStatus.error_code()));
  }
...
SolAR::FrameworkReturnCode  IWorldGraphManager_grpcProxy::deleteFile()
{
  ::grpc::ClientContext context;
  ::grpcIWorldGraphManager::deleteFileRequest reqIn;
  ::grpcIWorldGraphManager::deleteFileResponse respOut;
  #ifndef DISABLE_GRPC_COMPRESSION
  ...
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime start = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IWorldGraphManager_grpcProxy::deleteFile request sent at " << to_simple_string(start) << std::endl;
  #endif
  ::grpc::Status grpcRemoteStatus = m_grpcStub->deleteFile(&context, reqIn, &respOut);
  #ifdef ENABLE_PROXY_TIMERS
  boost::posix_time::ptime end = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IWorldGraphManager_grpcProxy::deleteFile response received at " << to_simple_string(end) << std::endl;
  std::cout << "   => elapsed time = " << ((end - start).total_microseconds() / 1000.00) << " ms" << std::endl;
  #endif
  if (!grpcRemoteStatus.ok())  {
    std::cout << "deleteFile rpc failed." << std::endl;
    throw xpcf::RemotingException("grpcIWorldGraphManagerService","deleteFile",static_cast<uint32_t>(grpcRemoteStatus.error_code()));
  }
