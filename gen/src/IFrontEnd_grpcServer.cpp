...
::grpc::Status IFrontEnd_grpcServer::grpcIFrontEndServiceImpl::getMapInfo(::grpc::ServerContext* context, const ::grpcIFrontEnd::getMapInfoRequest* request, ::grpcIFrontEnd::getMapInfoResponse* response)
{
  ...
  std::vector<SolAR::datastructure::Map::MapProcessingStep> mapProcessingHistory = xpcf::deserialize<std::vector<SolAR::datastructure::Map::MapProcessingStep>>(request->mapprocessinghistory());
  SolAR::FrameworkReturnCode returnValue = m_xpcfComponent->getMapInfo(accessToken, mapUUID, version, globalDescriptorType, descriptorType, dataSize, areImageSaved, mapProcessingHistory);
  ...
  response->set_mapprocessinghistory(xpcf::serialize<std::vector<SolAR::datastructure::Map::MapProcessingStep>>(mapProcessingHistory));
  response->set_xpcfgrpcreturnvalue(static_cast<int32_t>(returnValue));
  #ifdef ENABLE_SERVER_TIMERS
  boost::posix_time::ptime end = boost::posix_time::microsec_clock::universal_time();
...
::grpc::Status IFrontEnd_grpcServer::grpcIFrontEndServiceImpl::getMapProcessingStatus(::grpc::ServerContext* context, const ::grpcIFrontEnd::getMapProcessingStatusRequest* request, ::grpcIFrontEnd::getMapProcessingStatusResponse* response)
{
  ...
  SolAR::FrameworkReturnCode returnValue = m_xpcfComponent->getMapProcessingStatus(accessToken, resultMapUUID, status, processingType, progress);
