...
::grpc::Status IRelocalizationTrackablePipeline_grpcServer::grpcIRelocalizationTrackablePipelineServiceImpl::init_grpc0(::grpc::ServerContext* context, const ::grpcIRelocalizationTrackablePipeline::init_grpc0Request* request, ::grpcIRelocalizationTrackablePipeline::init_grpc0Response* response)
{
  ...
  response->set_xpcfgrpcreturnvalue(xpcf::serialize<SolAR::FrameworkReturnCode>(returnValue));
  #ifdef ENABLE_SERVER_TIMERS
...
::grpc::Status IRelocalizationTrackablePipeline_grpcServer::grpcIRelocalizationTrackablePipelineServiceImpl::start(::grpc::ServerContext* context, const ::grpcIRelocalizationTrackablePipeline::startRequest* request, ::grpcIRelocalizationTrackablePipeline::startResponse* response)
{
  #ifndef DISABLE_GRPC_COMPRESSION
  xpcf::grpcCompressType askedCompressionType = static_cast<xpcf::grpcCompressType>(request->grpcservercompressionformat());
...
::grpc::Status IRelocalizationTrackablePipeline_grpcServer::grpcIRelocalizationTrackablePipelineServiceImpl::stop(::grpc::ServerContext* context, const ::grpcIRelocalizationTrackablePipeline::stopRequest* request, ::grpcIRelocalizationTrackablePipeline::stopResponse* response)
{
  #ifndef DISABLE_GRPC_COMPRESSION
  xpcf::grpcCompressType askedCompressionType = static_cast<xpcf::grpcCompressType>(request->grpcservercompressionformat());
...
::grpc::Status IRelocalizationTrackablePipeline_grpcServer::grpcIRelocalizationTrackablePipelineServiceImpl::init_grpc2(::grpc::ServerContext* context, const ::grpcIRelocalizationTrackablePipeline::init_grpc2Request* request, ::grpcIRelocalizationTrackablePipeline::init_grpc2Response* response)
{
  ...
  SolAR::FrameworkReturnCode returnValue = m_xpcfComponent->init(trackableObjects);
  response->set_xpcfgrpcreturnvalue(xpcf::serialize<SolAR::FrameworkReturnCode>(returnValue));
  #ifdef ENABLE_SERVER_TIMERS
  boost::posix_time::ptime end = boost::posix_time::microsec_clock::universal_time();
  std::cout << "====> IRelocalizationTrackablePipeline_grpcServer::init response sent at " << to_simple_string(end) << std::endl;
