...
class IFrontEnd_grpcProxy:  public org::bcom::xpcf::ConfigurableBase, virtual public SolAR::api::service::IFrontEnd {
  public:
    ...
    SolAR::FrameworkReturnCode imageSegmentationProcessRequest(std::string const& accessToken, std::string const& clientUUID, SRef<SolAR::datastructure::Image> image)     override;
    SolAR::FrameworkReturnCode imageSegmentationProcessRequest(std::string const& accessToken, std::string const& clientUUID, std::vector<SRef<SolAR::datastructure::Image>> const& images, bool temporalConsistency)     override;
    SolAR::FrameworkReturnCode getImageSegmentationProcessStatus(std::string const& accessToken, std::string const& clientUUID, SolAR::api::pipeline::IImageSegmentationPipeline::Status& status, float& progress)     const     override;
    SolAR::FrameworkReturnCode getImageSegmentationProcessOutputMasks(std::string const& accessToken, std::string const& clientUUID, SRef<SolAR::datastructure::Mask2DCollection>& mask)     const     override;
