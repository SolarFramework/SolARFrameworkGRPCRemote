  ...
  class WithCallbackMethod_getType : public BaseClass {
   ...
   public:
    WithCallbackMethod_getType() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::google::protobuf::Empty, ::grpcIKeypointDetector::getTypeResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::google::protobuf::Empty* request, ::grpcIKeypointDetector::getTypeResponse* response) { return this->getType(context, request, response); }));}
    void SetMessageAllocatorFor_getType(
        ::grpc::MessageAllocator< ::google::protobuf::Empty, ::grpcIKeypointDetector::getTypeResponse>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* getType(
      ::grpc::CallbackServerContext* /*context*/, const ::google::protobuf::Empty* /*request*/, ::grpcIKeypointDetector::getTypeResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
