...
class grpcI3DOverlayService final {
 public:
  ...
  class WithCallbackMethod_setCameraParameters : public BaseClass {
   ...
   public:
    WithCallbackMethod_setCameraParameters() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpcI3DOverlay::setCameraParametersRequest, ::google::protobuf::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpcI3DOverlay::setCameraParametersRequest* request, ::google::protobuf::Empty* response) { return this->setCameraParameters(context, request, response); }));}
    void SetMessageAllocatorFor_setCameraParameters(
        ::grpc::MessageAllocator< ::grpcI3DOverlay::setCameraParametersRequest, ::google::protobuf::Empty>* allocator) {
    ...
    virtual ::grpc::ServerUnaryReactor* setCameraParameters(
      ::grpc::CallbackServerContext* /*context*/, const ::grpcI3DOverlay::setCameraParametersRequest* /*request*/, ::google::protobuf::Empty* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_setCameraParameters<WithCallbackMethod_draw<Service > > CallbackService;
