...
void mapRequest::set_digitalpoints(ArgT0&& arg0, ArgT... args) {
 ...
 digitalpoints_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void mapRequest::_internal_set_digitalpoints(const std::string& value) {
  ...
  digitalpoints_.Set(value, GetArenaForAllocation());
}
inline std::string* mapRequest::_internal_mutable_digitalpoints() {
  
  return digitalpoints_.Mutable(GetArenaForAllocation());
}
...
inline void mapRequest::set_allocated_digitalpoints(std::string* digitalpoints) {
  ...
  digitalpoints_.SetAllocated(digitalpoints, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (digitalpoints_.IsDefault()) {
    digitalpoints_.Set("", GetArenaForAllocation());
  }
