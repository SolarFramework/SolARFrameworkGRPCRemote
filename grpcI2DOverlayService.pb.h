...
void drawCircleRequest::set_point(ArgT0&& arg0, ArgT... args) {
 ...
 point_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void drawCircleRequest::_internal_set_point(const std::string& value) {
  ...
  point_.Set(value, GetArenaForAllocation());
}
inline std::string* drawCircleRequest::_internal_mutable_point() {
  
  return point_.Mutable(GetArenaForAllocation());
}
...
inline void drawCircleRequest::set_allocated_point(std::string* point) {
  ...
  point_.SetAllocated(point, GetArenaForAllocation());
