...
::grpc::Status IUnproject_grpcServer::grpcIUnprojectServiceImpl::setCameraParameters(::grpc::ServerContext* context, const ::grpcIUnproject::setCameraParametersRequest* request, ::google::protobuf::Empty* response)
{
  ...
  std::cout << "====> IUnproject_grpcServer::setCameraParameters request received at " << to_simple_string(start) << std::endl;
  #endif
  ...
  std::cout << "====> IUnproject_grpcServer::setCameraParameters response sent at " << to_simple_string(end) << std::endl;
