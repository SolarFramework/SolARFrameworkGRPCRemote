...
class match_grpc2Request final :
 ...
 public:
  ...
  void MergeFrom( const match_grpc2Request& from) {
    match_grpc2Request::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class match_grpc2Response final :
 ...
 public:
  ...
  void MergeFrom( const match_grpc2Response& from) {
    match_grpc2Response::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void match_grpc0Request::set_points2d1(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.points2d1_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* match_grpc0Request::release_points2d1() {
  ...
  return _impl_.points2d1_.Release();
}
inline void match_grpc0Request::set_allocated_points2d1(std::string* points2d1) {
  ...
  _impl_.points2d1_.SetAllocated(points2d1, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.points2d1_.IsDefault()) {
...
void match_grpc0Request::set_points2d2(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.points2d2_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* match_grpc0Request::release_points2d2() {
  ...
  return _impl_.points2d2_.Release();
}
inline void match_grpc0Request::set_allocated_points2d2(std::string* points2d2) {
  ...
  _impl_.points2d2_.SetAllocated(points2d2, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.points2d2_.IsDefault()) {
...
inline void match_grpc0Request::_internal_set_matchingdistancemax(float value) {
  ...
  _impl_.matchingdistancemax_ = value;
}
...
void match_grpc2Request::set_currentframe(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.currentframe_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* match_grpc2Request::release_currentframe() {
  ...
  return _impl_.currentframe_.Release();
}
inline void match_grpc2Request::set_allocated_currentframe(std::string* currentframe) {
  ...
  _impl_.currentframe_.SetAllocated(currentframe, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.currentframe_.IsDefault()) {
...
void match_grpc2Request::set_lastframe(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.lastframe_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* match_grpc2Request::release_lastframe() {
  ...
  return _impl_.lastframe_.Release();
}
inline void match_grpc2Request::set_allocated_lastframe(std::string* lastframe) {
  ...
  _impl_.lastframe_.SetAllocated(lastframe, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.lastframe_.IsDefault()) {
