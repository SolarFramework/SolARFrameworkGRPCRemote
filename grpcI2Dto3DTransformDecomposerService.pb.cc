...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_grpcI2Dto3DTransformDecomposerService_2eproto[3];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_grpcI2Dto3DTransformDecomposerService_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::grpcI2Dto3DTransformDecomposer::setCameraParametersRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::grpcI2Dto3DTransformDecomposer::setCameraParametersRequest, intrinsicparams_),
  PROTOBUF_FIELD_OFFSET(::grpcI2Dto3DTransformDecomposer::setCameraParametersRequest, distorsionparams_),
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::grpcI2Dto3DTransformDecomposer::_setCameraParametersRequest_default_instance_),
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_grpcI2Dto3DTransformDecomposerService_2eproto_getter() {
...
setCameraParametersRequest::setCameraParametersRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
}
setCameraParametersRequest::setCameraParametersRequest(const setCameraParametersRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
}
...
setCameraParametersRequest::~setCameraParametersRequest() {
  // @@protoc_insertion_point(destructor:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
...
// @@protoc_insertion_point(message_clear_start:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
...
::PROTOBUF_NAMESPACE_ID::uint8* setCameraParametersRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
  return target;
}

size_t setCameraParametersRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:grpcI2Dto3DTransformDecomposer.setCameraParametersRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void decomposeRequest::InternalSwap(decomposeRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &decomposedposes_, GetArenaForAllocation(),
      &other->decomposedposes_, other->GetArenaForAllocation()
  );
}
...
::PROTOBUF_NAMESPACE_ID::Metadata decomposeResponse::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_grpcI2Dto3DTransformDecomposerService_2eproto_getter, &descriptor_table_grpcI2Dto3DTransformDecomposerService_2eproto_once,
      file_level_metadata_grpcI2Dto3DTransformDecomposerService_2eproto[2]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace grpcI2Dto3DTransformDecomposer
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::grpcI2Dto3DTransformDecomposer::setCameraParametersRequest* Arena::CreateMaybeMessage< ::grpcI2Dto3DTransformDecomposer::setCameraParametersRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::grpcI2Dto3DTransformDecomposer::setCameraParametersRequest >(arena);
}
