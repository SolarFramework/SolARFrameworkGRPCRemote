...
const uint32_t TableStruct_grpcIDescriptorMatcherStereoService_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Request, _impl_.grpcservercompressionformat_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Request, _impl_.descriptors1_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Request, _impl_.descriptors2_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Request, _impl_.undistortedkeypoints1_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Request, _impl_.undistortedkeypoints2_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Request, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Request, _impl_.matches_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Response, _impl_.matches_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc0Response, _impl_.xpcfgrpcreturnvalue_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc1Request, _impl_.grpcservercompressionformat_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc1Request, _impl_.frame1_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc1Request, _impl_.frame2_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc1Request, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc1Request, _impl_.matches_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc1Response, _impl_.matches_),
  PROTOBUF_FIELD_OFFSET(::grpcIDescriptorMatcherStereo::match_grpc1Response, _impl_.xpcfgrpcreturnvalue_),
};
