...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_grpcIDescriptorMatcherStereoService_2eproto[4];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_grpcIDescriptorMatcherStereoService_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_grpcIDescriptorMatcherStereoService_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_grpcIDescriptorMatcherStereoService_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::grpcIDescriptorMatcherStereo::match_grpc0Request)},
  { 11, -1, sizeof(::grpcIDescriptorMatcherStereo::match_grpc0Response)},
  { 18, -1, sizeof(::grpcIDescriptorMatcherStereo::match_grpc1Request)},
  { 27, -1, sizeof(::grpcIDescriptorMatcherStereo::match_grpc1Response)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::grpcIDescriptorMatcherStereo::_match_grpc0Request_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::grpcIDescriptorMatcherStereo::_match_grpc0Response_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::grpcIDescriptorMatcherStereo::_match_grpc1Request_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::grpcIDescriptorMatcherStereo::_match_grpc1Response_default_instance_),
};
...
const char descriptor_table_protodef_grpcIDescriptorMatcherStereoService_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "e/protobuf/empty.proto\"\235\001\n\022match_grpc0Re"
  "quest\022\024\n\014descriptors1\030\001 \001(\014\022\024\n\014descripto"
  "rs2\030\002 \001(\014\022\035\n\025undistortedKeypoints1\030\003 \001(\014"
  "\022\035\n\025undistortedKeypoints2\030\004 \001(\014\022\014\n\004type\030"
  "\005 \001(\014\022\017\n\007matches\030\006 \001(\014\"C\n\023match_grpc0Res"
  "ponse\022\017\n\007matches\030\001 \001(\014\022\033\n\023xpcfGrpcReturn"
  "Value\030\002 \001(\021\"S\n\022match_grpc1Request\022\016\n\006fra"
  "me1\030\001 \001(\014\022\016\n\006frame2\030\002 \001(\014\022\014\n\004type\030\003 \001(\014\022"
  "\017\n\007matches\030\004 \001(\014\"C\n\023match_grpc1Response\022"
  "\017\n\007matches\030\001 \001(\014\022\033\n\023xpcfGrpcReturnValue\030"
  "\002 \001(\0212\221\002\n#grpcIDescriptorMatcherStereoSe"
  "rvice\022t\n\013match_grpc0\0220.grpcIDescriptorMa"
  "tcherStereo.match_grpc0Request\0321.grpcIDe"
  "scriptorMatcherStereo.match_grpc0Respons"
  "e\"\000\022t\n\013match_grpc1\0220.grpcIDescriptorMatc"
  "herStereo.match_grpc1Request\0321.grpcIDesc"
  "riptorMatcherStereo.match_grpc1Response\""
  "\000b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_grpcIDescriptorMatcherStereoService_2eproto_deps[1] = {
  &::descriptor_table_google_2fprotobuf_2fempty_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_grpcIDescriptorMatcherStereoService_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_grpcIDescriptorMatcherStereoService_2eproto = {
  false, false, 769, descriptor_table_protodef_grpcIDescriptorMatcherStereoService_2eproto, "grpcIDescriptorMatcherStereoService.proto", 
  ...
  file_level_metadata_grpcIDescriptorMatcherStereoService_2eproto, file_level_enum_descriptors_grpcIDescriptorMatcherStereoService_2eproto, file_level_service_descriptors_grpcIDescriptorMatcherStereoService_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_grpcIDescriptorMatcherStereoService_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_grpcIDescriptorMatcherStereoService_2eproto);
  return descriptor_table_grpcIDescriptorMatcherStereoService_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_grpcIDescriptorMatcherStereoService_2eproto(&descriptor_table_grpcIDescriptorMatcherStereoService_2eproto);
namespace grpcIDescriptorMatcherStereo {
...
// @@protoc_insertion_point(generalized_merge_from_start:grpcIDescriptorMatcherStereo.match_grpc0Request)
  GOOGLE_DCHECK_NE(&from, this);
  const match_grpc0Request* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<match_grpc0Request>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:grpcIDescriptorMatcherStereo.match_grpc0Request)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:grpcIDescriptorMatcherStereo.match_grpc0Request)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:grpcIDescriptorMatcherStereo.match_grpc0Request)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(generalized_merge_from_start:grpcIDescriptorMatcherStereo.match_grpc0Response)
  GOOGLE_DCHECK_NE(&from, this);
  const match_grpc0Response* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<match_grpc0Response>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:grpcIDescriptorMatcherStereo.match_grpc0Response)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:grpcIDescriptorMatcherStereo.match_grpc0Response)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:grpcIDescriptorMatcherStereo.match_grpc0Response)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(generalized_merge_from_start:grpcIDescriptorMatcherStereo.match_grpc1Request)
  GOOGLE_DCHECK_NE(&from, this);
  const match_grpc1Request* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<match_grpc1Request>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:grpcIDescriptorMatcherStereo.match_grpc1Request)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:grpcIDescriptorMatcherStereo.match_grpc1Request)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:grpcIDescriptorMatcherStereo.match_grpc1Request)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(generalized_merge_from_start:grpcIDescriptorMatcherStereo.match_grpc1Response)
  GOOGLE_DCHECK_NE(&from, this);
  const match_grpc1Response* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<match_grpc1Response>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:grpcIDescriptorMatcherStereo.match_grpc1Response)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:grpcIDescriptorMatcherStereo.match_grpc1Response)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:grpcIDescriptorMatcherStereo.match_grpc1Response)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::grpcIDescriptorMatcherStereo::match_grpc0Request* Arena::CreateMaybeMessage< ::grpcIDescriptorMatcherStereo::match_grpc0Request >(Arena* arena) {
  return Arena::CreateMessageInternal< ::grpcIDescriptorMatcherStereo::match_grpc0Request >(arena);
}
template<> PROTOBUF_NOINLINE ::grpcIDescriptorMatcherStereo::match_grpc0Response* Arena::CreateMaybeMessage< ::grpcIDescriptorMatcherStereo::match_grpc0Response >(Arena* arena) {
  return Arena::CreateMessageInternal< ::grpcIDescriptorMatcherStereo::match_grpc0Response >(arena);
}
template<> PROTOBUF_NOINLINE ::grpcIDescriptorMatcherStereo::match_grpc1Request* Arena::CreateMaybeMessage< ::grpcIDescriptorMatcherStereo::match_grpc1Request >(Arena* arena) {
  return Arena::CreateMessageInternal< ::grpcIDescriptorMatcherStereo::match_grpc1Request >(arena);
}
template<> PROTOBUF_NOINLINE ::grpcIDescriptorMatcherStereo::match_grpc1Response* Arena::CreateMaybeMessage< ::grpcIDescriptorMatcherStereo::match_grpc1Response >(Arena* arena) {
