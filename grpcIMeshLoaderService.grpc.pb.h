...
#ifndef GRPC_grpcIMeshLoaderService_2eproto__INCLUDED
#define GRPC_grpcIMeshLoaderService_2eproto__INCLUDED
...
class grpcIMeshLoaderService final {
 public:
  static constexpr char const* service_full_name() {
    return "grpcIMeshLoader.grpcIMeshLoaderService";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    virtual ::grpc::Status load(::grpc::ClientContext* context, const ::grpcIMeshLoader::loadRequest& request, ::grpcIMeshLoader::loadResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpcIMeshLoader::loadResponse>> Asyncload(::grpc::ClientContext* context, const ::grpcIMeshLoader::loadRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpcIMeshLoader::loadResponse>>(AsyncloadRaw(context, request, cq));
    }
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status load(::grpc::ServerContext* context, const ::grpcIMeshLoader::loadRequest* request, ::grpcIMeshLoader::loadResponse* response);
  };
  ...
  class WithAsyncMethod_load : public BaseClass {
   ...
   public:
    ...
    void Requestload(::grpc::ServerContext* context, ::grpcIMeshLoader::loadRequest* request, ::grpc::ServerAsyncResponseWriter< ::grpcIMeshLoader::loadResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithStreamedUnaryMethod_load : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_load() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpcIMeshLoader::loadRequest, ::grpcIMeshLoader::loadResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpcIMeshLoader::loadRequest, ::grpcIMeshLoader::loadResponse>* streamer) {
    ...
    virtual ::grpc::Status Streamedload(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpcIMeshLoader::loadRequest,::grpcIMeshLoader::loadResponse>* server_unary_streamer) = 0;
  };
...
#endif  // GRPC_grpcIMeshLoaderService_2eproto__INCLUDED
