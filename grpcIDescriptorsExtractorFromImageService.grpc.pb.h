 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void getTypeString(::grpc::ClientContext* context, const ::grpcIDescriptorsExtractorFromImage::getTypeStringRequest* request, ::grpcIDescriptorsExtractorFromImage::getTypeStringResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #else
      void getTypeString(::grpc::ClientContext* context, const ::grpcIDescriptorsExtractorFromImage::getTypeStringRequest* request, ::grpcIDescriptorsExtractorFromImage::getTypeStringResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
  ...
  class ExperimentalWithCallbackMethod_getTypeString : public BaseClass {
   ...
   public:
    ...
    #endif
                     context, const ::grpcIDescriptorsExtractorFromImage::getTypeStringRequest* request, ::grpcIDescriptorsExtractorFromImage::getTypeStringResponse* response) { return this->getTypeString(context, request, response); }));}
    void SetMessageAllocatorFor_getTypeString(
        ::grpc::experimental::MessageAllocator< ::grpcIDescriptorsExtractorFromImage::getTypeStringRequest, ::grpcIDescriptorsExtractorFromImage::getTypeStringResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    virtual ::grpc::ServerUnaryReactor* getTypeString(
      ::grpc::CallbackServerContext* /*context*/, const ::grpcIDescriptorsExtractorFromImage::getTypeStringRequest* /*request*/, ::grpcIDescriptorsExtractorFromImage::getTypeStringResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* getTypeString(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::grpcIDescriptorsExtractorFromImage::getTypeStringRequest* /*request*/, ::grpcIDescriptorsExtractorFromImage::getTypeStringResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
