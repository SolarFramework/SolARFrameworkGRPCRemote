...
#include "Dev/SolAR/SolARFramework/interfaces/api/input/files/IPointCloudLoader.h"
...
class IPointCloudLoader_grpcProxy:  public org::bcom::xpcf::ConfigurableBase, virtual public SolAR::api::input::files::IPointCloudLoader {
  public:
    ...
    SolAR::FrameworkReturnCode load(SRef<SolAR::datastructure::PointCloud>& pointCloud)     override;
