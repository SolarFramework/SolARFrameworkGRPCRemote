 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void estimate_grpc0(::grpc::ClientContext* context, const ::grpcIOpticalFlowEstimator::estimate_grpc0Request* request, ::grpcIOpticalFlowEstimator::estimate_grpc0Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      ...
      #else
      virtual void estimate_grpc1(::grpc::ClientContext* context, const ::grpcIOpticalFlowEstimator::estimate_grpc1Request* request, ::grpcIOpticalFlowEstimator::estimate_grpc1Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #else
      void estimate_grpc0(::grpc::ClientContext* context, const ::grpcIOpticalFlowEstimator::estimate_grpc0Request* request, ::grpcIOpticalFlowEstimator::estimate_grpc0Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      ...
      #else
      void estimate_grpc1(::grpc::ClientContext* context, const ::grpcIOpticalFlowEstimator::estimate_grpc1Request* request, ::grpcIOpticalFlowEstimator::estimate_grpc1Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_estimate_grpc0 : public BaseClass {
   ...
   public:
    ...
    #endif
                     context, const ::grpcIOpticalFlowEstimator::estimate_grpc0Request* request, ::grpcIOpticalFlowEstimator::estimate_grpc0Response* response) { return this->estimate_grpc0(context, request, response); }));}
    void SetMessageAllocatorFor_estimate_grpc0(
        ::grpc::experimental::MessageAllocator< ::grpcIOpticalFlowEstimator::estimate_grpc0Request, ::grpcIOpticalFlowEstimator::estimate_grpc0Response>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    virtual ::grpc::ServerUnaryReactor* estimate_grpc0(
      ::grpc::CallbackServerContext* /*context*/, const ::grpcIOpticalFlowEstimator::estimate_grpc0Request* /*request*/, ::grpcIOpticalFlowEstimator::estimate_grpc0Response* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* estimate_grpc0(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::grpcIOpticalFlowEstimator::estimate_grpc0Request* /*request*/, ::grpcIOpticalFlowEstimator::estimate_grpc0Response* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_estimate_grpc1 : public BaseClass {
   ...
   public:
        ...
        MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpcIOpticalFlowEstimator::estimate_grpc1Request, ::grpcIOpticalFlowEstimator::estimate_grpc1Response>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpcIOpticalFlowEstimator::estimate_grpc1Request* request, ::grpcIOpticalFlowEstimator::estimate_grpc1Response* response) { return this->estimate_grpc1(context, request, response); }));}
    void SetMessageAllocatorFor_estimate_grpc1(
        ::grpc::experimental::MessageAllocator< ::grpcIOpticalFlowEstimator::estimate_grpc1Request, ::grpcIOpticalFlowEstimator::estimate_grpc1Response>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    virtual ::grpc::ServerUnaryReactor* estimate_grpc1(
      ::grpc::CallbackServerContext* /*context*/, const ::grpcIOpticalFlowEstimator::estimate_grpc1Request* /*request*/, ::grpcIOpticalFlowEstimator::estimate_grpc1Response* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* estimate_grpc1(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::grpcIOpticalFlowEstimator::estimate_grpc1Request* /*request*/, ::grpcIOpticalFlowEstimator::estimate_grpc1Response* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
