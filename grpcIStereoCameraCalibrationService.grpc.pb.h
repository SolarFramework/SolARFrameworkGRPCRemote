    ...
    WithCallbackMethod_calibrate() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpcIStereoCameraCalibration::calibrateRequest, ::grpcIStereoCameraCalibration::calibrateResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpcIStereoCameraCalibration::calibrateRequest* request, ::grpcIStereoCameraCalibration::calibrateResponse* response) { return this->calibrate(context, request, response); }));}
    void SetMessageAllocatorFor_calibrate(
        ::grpc::MessageAllocator< ::grpcIStereoCameraCalibration::calibrateRequest, ::grpcIStereoCameraCalibration::calibrateResponse>* allocator) {
