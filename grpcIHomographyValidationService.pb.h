...
class isValidRequest final :
 ...
 public:
  ...
  ~isValidRequest() override;
  explicit PROTOBUF_CONSTEXPR isValidRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  isValidRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const isValidRequest& from) {
    isValidRequest::MergeImpl(*this, from);
  }
  private:
  ...
  void set_ref2dsquaredmarkercorners(ArgT0&& arg0, ArgT... args);
  std::string* mutable_ref2dsquaredmarkercorners();
  PROTOBUF_NODISCARD std::string* release_ref2dsquaredmarkercorners();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_ref2dsquaredmarkercorners(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_projected2dsquaredmarkercorners(ArgT0&& arg0, ArgT... args);
  std::string* mutable_projected2dsquaredmarkercorners();
  PROTOBUF_NODISCARD std::string* release_projected2dsquaredmarkercorners();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_projected2dsquaredmarkercorners(const std::string& value);
...
class isValidResponse final :
 ...
 public:
  ...
  ~isValidResponse() override;
  explicit PROTOBUF_CONSTEXPR isValidResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  isValidResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const isValidResponse& from) {
    isValidResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline int32_t isValidRequest::_internal_grpcservercompressionformat() const {
  return _impl_.grpcservercompressionformat_;
}
inline int32_t isValidRequest::grpcservercompressionformat() const {
  // @@protoc_insertion_point(field_get:grpcIHomographyValidation.isValidRequest.grpcServerCompressionFormat)
  return _internal_grpcservercompressionformat();
}
inline void isValidRequest::_internal_set_grpcservercompressionformat(int32_t value) {
  
  _impl_.grpcservercompressionformat_ = value;
}
inline void isValidRequest::set_grpcservercompressionformat(int32_t value) {
...
void isValidRequest::set_ref2dsquaredmarkercorners(ArgT0&& arg0, ArgT... args) {
 
 _impl_.ref2dsquaredmarkercorners_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* isValidRequest::mutable_ref2dsquaredmarkercorners() {
  std::string* _s = _internal_mutable_ref2dsquaredmarkercorners();
...
inline const std::string& isValidRequest::_internal_ref2dsquaredmarkercorners() const {
  return _impl_.ref2dsquaredmarkercorners_.Get();
}
inline void isValidRequest::_internal_set_ref2dsquaredmarkercorners(const std::string& value) {
  
  _impl_.ref2dsquaredmarkercorners_.Set(value, GetArenaForAllocation());
}
inline std::string* isValidRequest::_internal_mutable_ref2dsquaredmarkercorners() {
  
  return _impl_.ref2dsquaredmarkercorners_.Mutable(GetArenaForAllocation());
}
inline std::string* isValidRequest::release_ref2dsquaredmarkercorners() {
  ...
  return _impl_.ref2dsquaredmarkercorners_.Release();
}
inline void isValidRequest::set_allocated_ref2dsquaredmarkercorners(std::string* ref2dsquaredmarkercorners) {
  ...
  _impl_.ref2dsquaredmarkercorners_.SetAllocated(ref2dsquaredmarkercorners, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.ref2dsquaredmarkercorners_.IsDefault()) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void isValidRequest::set_projected2dsquaredmarkercorners(ArgT0&& arg0, ArgT... args) {
 
 _impl_.projected2dsquaredmarkercorners_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* isValidRequest::mutable_projected2dsquaredmarkercorners() {
  std::string* _s = _internal_mutable_projected2dsquaredmarkercorners();
...
inline const std::string& isValidRequest::_internal_projected2dsquaredmarkercorners() const {
  return _impl_.projected2dsquaredmarkercorners_.Get();
}
inline void isValidRequest::_internal_set_projected2dsquaredmarkercorners(const std::string& value) {
  
  _impl_.projected2dsquaredmarkercorners_.Set(value, GetArenaForAllocation());
}
inline std::string* isValidRequest::_internal_mutable_projected2dsquaredmarkercorners() {
  
  return _impl_.projected2dsquaredmarkercorners_.Mutable(GetArenaForAllocation());
}
inline std::string* isValidRequest::release_projected2dsquaredmarkercorners() {
  ...
  return _impl_.projected2dsquaredmarkercorners_.Release();
}
inline void isValidRequest::set_allocated_projected2dsquaredmarkercorners(std::string* projected2dsquaredmarkercorners) {
  ...
  _impl_.projected2dsquaredmarkercorners_.SetAllocated(projected2dsquaredmarkercorners, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.projected2dsquaredmarkercorners_.IsDefault()) {
