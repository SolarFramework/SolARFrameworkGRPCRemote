...
class triangulate_grpc3Request PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kCurKeyframeFieldNumber = 1,
    kMatchesFieldNumber = 2,
    kPcloudFieldNumber = 3,
  };
  // bytes curKeyframe = 1;
  void clear_curkeyframe();
  const std::string& curkeyframe() const;
  void set_curkeyframe(const std::string& value);
  void set_curkeyframe(std::string&& value);
  void set_curkeyframe(const char* value);
  void set_curkeyframe(const void* value, size_t size);
  std::string* mutable_curkeyframe();
  std::string* release_curkeyframe();
  void set_allocated_curkeyframe(std::string* curkeyframe);
  private:
  const std::string& _internal_curkeyframe() const;
  void _internal_set_curkeyframe(const std::string& value);
  std::string* _internal_mutable_curkeyframe();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr curkeyframe_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr matches_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr pcloud_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_grpcITriangulatorService_2eproto;
...
// bytes curKeyframe = 1;
inline void triangulate_grpc3Request::clear_curkeyframe() {
  curkeyframe_.ClearToEmpty();
}
inline const std::string& triangulate_grpc3Request::curkeyframe() const {
  // @@protoc_insertion_point(field_get:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
  return _internal_curkeyframe();
}
inline void triangulate_grpc3Request::set_curkeyframe(const std::string& value) {
  _internal_set_curkeyframe(value);
  // @@protoc_insertion_point(field_set:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
}
inline std::string* triangulate_grpc3Request::mutable_curkeyframe() {
  // @@protoc_insertion_point(field_mutable:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
  return _internal_mutable_curkeyframe();
}
inline const std::string& triangulate_grpc3Request::_internal_curkeyframe() const {
  return curkeyframe_.Get();
}
inline void triangulate_grpc3Request::_internal_set_curkeyframe(const std::string& value) {
  
  curkeyframe_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void triangulate_grpc3Request::set_curkeyframe(std::string&& value) {
  
  curkeyframe_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
}
inline void triangulate_grpc3Request::set_curkeyframe(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  curkeyframe_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
}
inline void triangulate_grpc3Request::set_curkeyframe(const void* value,
    size_t size) {
  
  curkeyframe_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
}
inline std::string* triangulate_grpc3Request::_internal_mutable_curkeyframe() {
  
  return curkeyframe_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* triangulate_grpc3Request::release_curkeyframe() {
  // @@protoc_insertion_point(field_release:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
  return curkeyframe_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void triangulate_grpc3Request::set_allocated_curkeyframe(std::string* curkeyframe) {
  if (curkeyframe != nullptr) {
    
  } else {
    
  }
  curkeyframe_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), curkeyframe,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:grpcITriangulator.triangulate_grpc3Request.curKeyframe)
}
